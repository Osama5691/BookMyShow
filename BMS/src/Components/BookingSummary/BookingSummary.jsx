...
function BookingSummary() {
  ...
  const [selectedType, setSelectedType] = useState("m-ticket")
...
//   useEffect(() => {
//   console.log("✅ Language received:", navLanguage);
//   console.log("✅ Screen received:", navScreen);
//   console.log("✅ Screen received:", image);
// }, [navLanguage, navScreen]);
  ...
  const handleProceed = () => {
    // console.log("this is booking-summary", image)
  ...
  const handleSkip = () => {
    if (title && theaterName && time && releaseDate && seatGroups) {
        ...
        <div className="top-section">
          <div className="left-sec">
            ...
            <div className="movie-info">
              <h3>{title} &nbsp;<span className="navRating">{navRating}</span></h3>
