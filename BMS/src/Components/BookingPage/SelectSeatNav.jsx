...
export default function SelectSeatNav() {
  ...
  const movieLanguage = navLanguage || localStorage.getItem("movieLanguage");
  const movieScreen = navScreen || localStorage.getItem("movieScreen");
  ...
  useEffect(() => {
    ...
    if (navLanguage) localStorage.setItem("movieLanguage", navLanguage);
  if (navScreen) localStorage.setItem("movieScreen", navScreen);
  }, [
    movieTitle,
    movieRating,
    movieGenre,
...
//   useEffect(() => {
//   console.log("🎯 Language received on SelectSeatNav:", navLanguage);
//   console.log("🎯 Screen received on SelectSeatNav:", navScreen);
// }, [navLanguage, navScreen]);

  // console.log("Final release date value: ", image);
