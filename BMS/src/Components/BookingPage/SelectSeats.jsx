...
const SelectSeats = ({ selectedSeats, setShowPriceButton , title, theaterName, time, format , releaseDate , navLanguage , navScreen , navRating , image}) => {
  ...
  const navigate = useNavigate();
    ...
    // console.log("Format in SelectSeatNav:", image); // 👈 yeh add karo
