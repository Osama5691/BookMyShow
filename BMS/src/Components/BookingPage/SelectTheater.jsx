...
const SelectTheater = ({ movieTitle , language , screen , rating , image }) => {
...
//  console.log(image);
  ...
  const handleSlotClick = (time, format, theaterName,) => {
    navigate("/select-seats", {
      state: { title: movieTitle, time, format, theaterName, releaseDate: releaseDate, language, screen , rating, image }
    });
  };
