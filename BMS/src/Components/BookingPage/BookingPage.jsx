...
export default function BookingPage() {
 ...
 const language = stateLanguage || localStorage.getItem("movieLanguage");
 const screen = stateScreen || localStorage.getItem("movieScreen");
 const image = stateImage || localStorage.getItem("movieImage");


// useEffect(() => {
//   console.log("Selected Format:", screen); // ✅ check in console
// }, [screen]);

//  console.log("✅ Final Movie Image to use:", image);
