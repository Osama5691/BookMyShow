...
//   useEffect(() => {
//   localStorage.clear();
//    console.log("Full LocalStorage Cleared");
// }, []);


  useEffect(() => {
    axios.get("http://localhost:5000/api/get-movies")
      .then(res => {
        setMovies(res.data);
        setLoading(false);
      })
  ...
  const mobileSlides = [
    { src: "./Banner7.png" },
    { src: "https://assets-in-gm.bmscdn.com/promotions/cms/creatives/1744877695866_revplaycard630x315.jpg" },
  ];
            ...
            : movies.slice(0, 5).map((movie) => (
              ...
              >
                ...
                <div className="rating-box">
                  ...
                  <span className="rating">{movie.ratingsz}</span>
